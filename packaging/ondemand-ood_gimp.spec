...
Summary:  Batch Connect - ISU-HPC Geneious
...
%description
An interactive app designed for ISU-HPC OnDemand that launches a GENEIOUS GUI within an XFCE desktop session on an Owens batch node.
